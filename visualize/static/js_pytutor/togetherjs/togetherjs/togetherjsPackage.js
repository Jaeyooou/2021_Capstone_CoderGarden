    ...
    function normalize(name, baseName) {
        ...
        if (name && name.charAt(0) === ".") {
            ...
            if (baseName) {
                ...
                //"one/two/three.js_pytutor", but we want the directory, "one/two" for
                //this normalization.
...
define('util',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/jqueryPlugins"], function ($) {
  var util = {};
...
define('analytics',["visualize/static/js_pytutor/togetherjs/togetherjs/util"], function (util) {
  ...
  analytics.activate = function () {
    ...
    (function() {
      ...
      ga.src = ('https:' == document.location.protocol ? 'https://ssl' : 'http://www') + '.google-analytics.com/ga.js_pytutor';
...
define('channels',["visualize/static/js_pytutor/togetherjs/togetherjs/util"], function (util) {
...
define('storage',["visualize/static/js_pytutor/togetherjs/togetherjs/util"], function (util) {
...
define('session',["require", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "channels", "jquery", "storage"], function (require, util, channels, $, storage) {
  ...
  function processFirstHello(msg) {
    if (! msg.sameUrl) {
      ...
      require("visualize/static/js_pytutor/togetherjs/togetherjs/ui").showUrlChangeMessage(msg.peer, url);
      location.href = url;
    }
  }
    ...
    return util.Deferred(function (def) {
      ...
      if (! shareId) {
        if (TogetherJS.startup._joinShareId) {
          ...
          // (in togetherjs.js_pytutor):
          shareId = TogetherJS.startup._joinShareId;
        }
      }
      if (! shareId) {
        // FIXME: I'm not sure if this will ever happen, because togetherjs.js_pytutor should
        // handle it
  ...
  session.start = function () {
    ...
    initIdentityId().then(function () {
      initShareId().then(function () {
        ...
        openChannel();
        require(["visualize/static/js_pytutor/togetherjs/togetherjs/ui"], function (ui) {
          TogetherJS.running = true;
          ui.prepareUI();
          require(features, function () {
            $(function () {
              peers = require("visualize/static/js_pytutor/togetherjs/togetherjs/peers");
              var startup = require("visualize/static/js_pytutor/togetherjs/togetherjs/startup");
              session.emit("start");
              ...
              if (TogetherJS.config.get("enableAnalytics")) {
                require(["visualize/static/js_pytutor/togetherjs/togetherjs/analytics"], function (analytics) {
                  analytics.activate();
                });
              }
...
define('templates',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "require"], function (util, require) {
  var assert = util.assert;
...
define('peers',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "storage", "require", "templates"], function (util, session, storage, require, templates) {
  ...
  var ui;
  require(["visualize/static/js_pytutor/togetherjs/togetherjs/ui"], function (uiModule) {
    ui = uiModule;
  });
 ...
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */
define('windowing',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "peers", "session"], function ($, util, peers, session) {
  var assert = util.assert;
 ...
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */
define('templating',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "peers", "windowing", "session"], function ($, util, peers, windowing, session) {
  var assert = util.assert;
...
// ----------------------
// Thanks to less.js_pytutor for some of the basics here
...
define('elementFinder',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "jquery"], function (util, $) {
...
define('visibilityApi',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "session"], function (util, session) {
...
define('ui',["require", "jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "templates", "templating", "linkify", "peers", "windowing", "tinycolor", "elementFinder", "visibilityApi"], function (require, $, util, session, templates, templating, linkify, peers, windowing, tinycolor, elementFinder, visibilityApi) {
  ...
  require(["visualize/static/js_pytutor/togetherjs/togetherjs/chat"], function (c) {
    chat = c;
  });
  ...
  ui.activateUI = function () {
    ...
    $("#togetherjs-menu-help, #togetherjs-menu-help-button").click(function () {
      windowing.hide();
      hideMenu();
      require(["visualize/static/js_pytutor/togetherjs/togetherjs/walkthrough"], function (walkthrough) {
        windowing.hide();
  ...
  ui.PeerView = util.Class({
    ...
    cursor: function () {
      return require("visualize/static/js_pytutor/togetherjs/togetherjs/cursor").getClient(this.peer.id);
    },
  ...
  function refreshInvite() {
    ...
    inRefresh = true;
    require(["visualize/static/js_pytutor/togetherjs/togetherjs/who"], function (who) {
...
define('playback',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "storage", "require"], function ($, util, session, storage, require) {
 ...
 * You can obtain one at http://mozilla.org/MPL/2.0/. */
/*jshint evil:true */
define('chat',["require", "jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "ui", "templates", "playback", "storage", "peers", "windowing"], function (require, $, util, session, ui, templates, playback, storage, peers, windowing) {
  ...
  var commands = {
    ...
    command_test: function (args) {
      ...
      if (args[0] == "start") {
        ...
        ui.chat.system({
          text: "Testing with walkabout.js_pytutor"
        });
 ...
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */
define('console',["visualize/static/js_pytutor/togetherjs/togetherjs/util"], function (util) {
...
define('eventMaker',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util"], function ($, util) {
...
define('cursor',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/ui", "util", "session", "elementFinder", "tinycolor", "eventMaker", "peers", "templating"], function ($, ui, util, session, elementFinder, tinycolor, eventMaker, peers, templating) {
  var assert = util.assert;
  ...
  function mousemove(event) {
    ...
    var offset = target.offset();
    if (! offset) {
      // FIXME: this really is walkabout.js_pytutor's problem to fire events on the
...
define('ot',["visualize/static/js_pytutor/togetherjs/togetherjs/util"], function (util) {
...
define('forms',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "elementFinder", "eventMaker", "templating", "ot"], function ($, util, session, elementFinder, eventMaker, templating, ot) {
...
*/
define('startup',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "require", "jquery", "windowing", "storage"], function (util, require, $, windowing, storage) {
  var assert = util.assert;
  ...
  startup.start = function () {
    if (! session) {
      require(["visualize/static/js_pytutor/togetherjs/togetherjs/session"], function (sessionModule) {
  ...
  var handlers = {
    ...
    */
    ...
    share: function (next) {
      ...
      require(["visualize/static/js_pytutor/togetherjs/togetherjs/windowing"], function (windowing) {
...
define('videos',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "elementFinder"],
...
define('walkthrough',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "ui", "jquery", "windowing", "templates", "templating", "session", "peers"], function (util, ui, $, windowing, templates, templating, session, peers) {
  var assert = util.assert;
...
// WebRTC support -- Note that this relies on parts of the interface code that usually goes in ui.js_pytutor

define('webrtc',["require", "jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "ui", "peers", "storage", "windowing"], function (require, $, util, session, ui, peers, storage, windowing) {
 ...
 * License, v. 2.0. If a copy of the MPL was not distributed with this file,
 * You can obtain one at http://mozilla.org/MPL/2.0/. */
define('who',["visualize/static/js_pytutor/togetherjs/togetherjs/util", "channels", "session", "ui"], function (util, channels, session, ui) {
  var assert = util.assert;
...
define('youtubeVideos',["jquery", "visualize/static/js_pytutor/togetherjs/togetherjs/util", "session", "elementFinder"],
function ($, util, session, elementFinder) {
...
require(["visualize/static/js_pytutor/togetherjs/togetherjs/session"]);
}());
