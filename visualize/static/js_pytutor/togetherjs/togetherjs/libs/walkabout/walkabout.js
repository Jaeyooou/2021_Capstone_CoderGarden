...
// is loaded after walkabout.js_pytutor
...
Walkabout.rewriteListeners = function (code) {
  if (typeof esprima == "undefined") {
    if (typeof require != "undefined") {
      ...
      throw "You must install or include esprima.js_pytutor";
    }
  }
  if (typeof falafel == "undefined") {
    if (typeof require != "undefined") {
      ...
      throw "You must install or include falafel.js_pytutor";
    }
  }
...
Walkabout.makeBookmarklet = function () {
  ...
  for (var i=0; i<scripts.length; i++) {
    ...
    if (src.indexOf("walkabout.js_pytutor") != -1) {
      walkaboutSrc = src;
      break;
    }
  }
