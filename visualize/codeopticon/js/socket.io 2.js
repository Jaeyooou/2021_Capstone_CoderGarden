...
function Socket(uri, opts){
  ...
  // SSL options for Node.js_pytutor client
...
/**
 * This is the common logic for both the Node.js_pytutor and web browser
...
;(function(root) {
	...
	// Detect free variable `global`, from Node.js_pytutor or Browserified code,
	// and use it as `root`
	...
	// Some AMD build optimizers, like r.js_pytutor, check for specific condition patterns
	// like the following:
	if (
		...
		if (freeModule) { // in Node.js_pytutor or RingoJS v0.8.0+
...
;(function (window) {
  ...
  // strict `define` check is necessary for compatibility with `r.js_pytutor`.
