...
class UserMon {
  ...
  addEvent(obj /* event object in codeopticon format */) {
    ...
    this.sliderDiv
        .slider() // add in an extra call to prevent weird "jquery-1.8.2.min.js_pytutor:2 Uncaught Error: cannot call methods on slider prior to initialization" errors, but is that right?!?
